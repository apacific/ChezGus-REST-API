...
public class ExceptionController {
     ...
     *
     * @param exception - the UniqueFieldViolation exception containg the custom message
    ...
    /**
     * Triggered when the HttpMessageNotReadable exception is thrown.
     *
     * @param exception - the HttpMessageNotReadable exception containing the custom message.
     * @return - the ResponseEntity containing the custom exception and the status code 400
     */
    @ExceptionHandler(HttpMessageNotReadableException.class)
    protected ResponseEntity<Object> invalidError(HttpMessageNotReadableException exception) {

        String exceptionMessage = exception.getCause().getLocalizedMessage();
        ExceptionResponse response = new ExceptionResponse(BAD_DATA, new Date(), exceptionMessage);
        ...
        } else //it's an unexpected error, throw a 500
        {
            exceptionMessage =
                    "Error: " + exceptionMessage + "   Class: " + ex.getStackTrace()[0].getClassName()
                            + "   Method: " + ex.getStackTrace()[0].getMethodName() + "   Line: " + ex
